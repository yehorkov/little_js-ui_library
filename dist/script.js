...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.tab = function () {
  for (let i = 0; i < this.length; i++) {
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).on('click', () => {
      Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).fadeIn(500).addClass('tab-item--active').siblings().removeClass('tab-item--active').closest('.tab').find('.tab-content').removeClass('tab-content--active').eq(Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).index()).addClass('tab-content--active');
    });
  }
};
...
$.prototype.init.prototype = $.prototype; // записываем в прототип функции наш главный прототип
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.closest = function (selector) {
  ...
  for (let i = 0; i < this.length; i++) {
    if (this[i].closest(selector)) {
      ...
      console.log(`This parent class ${selector} is not found`);
    }
  }
  const objLength = Object.keys(this).length;
